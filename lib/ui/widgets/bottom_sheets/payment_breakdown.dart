...
import '../../pages/games/ticket_sales_receipt.dart';
...
class PaymentBreakdown extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final orderDetailsVm = ref.watch(orderDetailsViewModel);
    return IgnorePointer(
      ignoring: orderDetailsVm.state == ViewState.busy,
      child: Padding(
