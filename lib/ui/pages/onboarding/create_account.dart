          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTextField(
                ...
                //validator: (value) => PasswordValidator.confirmPassword(value, source: _pwd.text),
                validator: FieldValidator.validate,
                keyboardType: TextInputType.text,
                suffixIcon: Padding(
                  padding: EdgeInsets.only(right: 16.w, left: 16.w),
              ...
              CustomButton(
                  ...
                  onPressed: () async{
                    pushNavigation(context: context, widget: const Otp(otpType: OtpType.createAccount, identifier: 'dejbaba@yopmail.com'), routeName: NamedRoutes.otp);
                  }
              ),
