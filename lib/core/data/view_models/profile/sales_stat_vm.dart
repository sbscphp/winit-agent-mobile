...
class SalesStatVm extends BaseState{
  ...
  double get bonusBalance => double.tryParse(salesStat?.bonusBalance?.toString() ?? '0') ?? 0;
  double get commissionsBalance => double.tryParse(salesStat?.commissionBalance?.toString() ?? '0') ?? 0;
